...
import CircleShape from '@/components/demo/css/CircleShape.vue'
import PieShape from '@/components/demo/css/PieShape.vue'
import TriangleShape from '@/components/demo/css/TriangleShape.vue'

## Triangle

<TriangleShape client:load />
